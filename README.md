[![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.17069741.svg)](https://doi.org/10.5281/zenodo.17069741) [![MATLAB](https://img.shields.io/badge/MATLAB-File_Exchange-color=68CA66)](https://se.mathworks.com/matlabcentral/fileexchange/181979-matlab-interface-to-w-wiscombe-s-mie-scattering-program)
...
3. **macOS**. Built with interleaved MATLAB MEX API. Supports **MATLAB R2023b** and all subsequent releases. Release files:
   * Binary file (Apple Silicon ARM platform): [`mlMIEV0.mexmaca64`](https://github.com/ilopushenko/miev0_matlab_interface/releases/download/v1.2/mlMIEV0.mexmaca64);
   * Corresponding [example script](https://github.com/ilopushenko/miev0_matlab_interface/releases/download/v1.2/example_scattered_intensities.m) (the same as for Windows).
...
If you use this code, please make a reference to the original **W. Wiscombe Appl. Opt. 1980 paper**. Also I would be very happy if you recognize my efforts on implementing this MEX interface by mentioning it somewhere in the acknowledgements, or by referring to the [Zenodo](https://zenodo.org/records/17069741) repository. 
