...
An example file for computing and plotting scattering intensities $S_1$ and $S_2$ is available in the repo root folder (see **example_scattered_intensities.m**). This script should result in the following polar plot:
