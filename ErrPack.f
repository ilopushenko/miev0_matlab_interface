c Changes by I.V.L.: implemented messages output to MATLAB Command window
...
c     ..
      ...
      WrtBad = .TRUE.
      NUMMSG = NUMMSG + 1
      WRITE( MSGMLAB, '(3A)' ) ' ****  Input variable  ', VarNam,
     &                               '  in error  ****'
...
c     ..
      ...
      WRITE( MSGMLAB, '(3A,I7)' ) ' ****  Symbolic dimension  ', 
